...
<script lang="ts">
  export const LoadingSpinnerColors = {
    PRIMARY: 'primary',
  ...
  export type LoadingSpinnerColor = typeof LoadingSpinnerColors[keyof typeof LoadingSpinnerColors];
...
<script setup
  ...
  const loadingSpinnerTextColor = computed(() => ({
